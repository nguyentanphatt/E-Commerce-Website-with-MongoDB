...
// mongodb
mongoose.connect("mongodb+srv://kyakya972003:qwert741%40@cluster0.tk7ce.mongodb.net/e-commerce")
...
app.post('/login', async (req,res)=>{
    ...
    if(user) {
        ...
        res.json({
            success: false,
            errors: 'Wrong email or not found email id'
        })
    }
})
...
//API for remove product in cart
